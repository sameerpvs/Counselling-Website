...
<div style=" width:550px; color: #1B68AE; left:0;"><br><br><h3 id="head"><strong><center>Retrival Form</center></strong> </h3><br><h5 style="color:red;"><?  echo $msg;?></h5></div>
<div class="well" style="border-bottom:0px !important">
<div class="table-responsive">
<table class="table-condensed">
<tr>
<td>
 <strong>Enter Mobile No or LastName *:</strong><input type="text" name="tenth" id="tenth" required title="please fill the field">
</td>
</tr>
 <div class="form-group" id="submit">
<tr><td >
  <center>
  <input type ="submit" name="sub"  style="background-color:transparent"  value="Submit"> </center></td></tr>
</table>
</div> 
</div>
</div>
...
<td>
<strong>Last Name</strong><input type="text" name="lname" id="lname" value="<? echo $lname; ?>" disabled>
</td>
</tr>
<tr>
<td>
 <strong>Father Name *</strong><input type="text" name="father" id="father" value="<? echo $father ;?>" disabled>
</td>
