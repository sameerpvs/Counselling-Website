...
<a href="chnge.php">Change Password</a>
...
<div id="main">
<center><br><br><h3 style="color: #1b68ae;"><b>Details of Counselling Done</b> </h3><br></center>
<?
$sql= "Select * from `info` where counsellor = '$name' ";
...
echo" </table> </div></div>";
$no = $count-1;
echo "<center><strong>Total Counselling done $no </strong> <center>";
