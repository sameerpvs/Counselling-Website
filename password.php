...
$MESSAGE_BODY ="<html>Dear ".$name.",<br>  Your Password for registered id </strong>".$username."</strong> in online  portal is <strong>".$password."</strong></html>";
  $mailheader .= "From: counselling@agi.in" . "\r\n"  ;
$mailheader .= "Reply-To:counselling@cvsr.ac.in" . "\r\n" ; 
